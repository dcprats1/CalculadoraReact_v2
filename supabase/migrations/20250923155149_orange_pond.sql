/*
  ...
  1. Nuevas Tablas
     - `tariffs` - Tarifas base por servicio, peso y zona
...
CREATE TABLE IF NOT EXISTS tariffs (
  ...
  provincial_price decimal(10,2) DEFAULT 0,
  regional_price decimal(10,2) DEFAULT 0,
  national_price decimal(10,2) DEFAULT 0,
  provincial_cost decimal(10,2) DEFAULT 0,
  regional_cost decimal(10,2) DEFAULT 0,
  national_cost decimal(10,2) DEFAULT 0,
...
-- Políticas para tariffs (lectura pública, escritura solo autenticados)
CREATE POLICY "Tariffs are viewable by everyone"
  ON tariffs
  FOR SELECT
  TO public
  USING (true);
...
CREATE INDEX IF NOT EXISTS idx_tariffs_service_weight ON tariffs(service_name, weight_from, weight_to);

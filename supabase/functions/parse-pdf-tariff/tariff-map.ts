    ...
    weights: [
      {
        weight_from: 0,
        weight_to: 3,
        label: '1ª Expedición 3kg',
        Provincial: { salidas: '1,82', recogidas: '1,82', interciudad: '2,49' },
        Regional: { salidas: '1,88', recogidas: '1,88', interciudad: '2,55' },
        Nacional: { salidas: '1,99', recogidas: '1,99', interciudad: '2,66' },
        Portugal_Peninsular: { salidas: '2,10', recogidas: '2,10', interciudad: '2,77' }
      },
      {
        weight_from: 3,
        weight_to: 999,
        label: 'Kg adicional',
        Provincial: { salidas: '0,17', recogidas: '0,17', interciudad: '0,21' },
        Regional: { salidas: '0,19', recogidas: '0,19', interciudad: '0,23' },
        Nacional: { salidas: '0,21', recogidas: '0,21', interciudad: '0,25' },
        Portugal_Peninsular: { salidas: '0,33', recogidas: '0,33', interciudad: '0,37' }
      }
    ]
  },
  {
    service_name: 'Parcel Shop Baleares Mayores',
    page: 17,
    type: 'insular',
    weights: [
      {
        ...
        weight_to: 1,
        label: '0-1kg',
        Baleares_Mayores: { salidas: '3,15', recogidas: '3,15', interciudad: '3,95' }
      },
      {
        weight_from: 1,
        weight_to: 3,
        label: '1-3kg',
        Baleares_Mayores: { salidas: '5,64', recogidas: '5,64', interciudad: '6,44' }
      },
      {
        weight_from: 3,
        weight_to: 5,
        label: '3-5kg',
        Baleares_Mayores: { salidas: '8,31', recogidas: '8,31', interciudad: '9,11' }
      },
      {
        weight_from: 5,
        weight_to: 10,
        label: '5-10kg',
        Baleares_Mayores: { salidas: '11,79', recogidas: '11,79', interciudad: '12,59' }
      },
      {
        weight_from: 10,
        weight_to: 15,
        label: '10-15kg',
        Baleares_Mayores: { salidas: '19,58', recogidas: '19,58', interciudad: '20,38' }
      },
      {
        weight_from: 15,
        weight_to: 999,
        label: 'Kg adicional',
        Baleares_Mayores: { salidas: '1,72', recogidas: '1,72', interciudad: '1,77' }
      }
    ]
  },
  {
    service_name: 'Parcel Shop Baleares Menores',
    page: 17,
    type: 'insular',
    weights: [
      {
        ...
        weight_to: 1,
        label: '0-1kg',
        Baleares_Menores: { salidas: '3,67', recogidas: '3,67', interciudad: '4,47' }
      },
      {
        weight_from: 1,
        weight_to: 3,
        label: '1-3kg',
        Baleares_Menores: { salidas: '6,24', recogidas: '6,24', interciudad: '7,04' }
      },
      {
        weight_from: 3,
        weight_to: 5,
        label: '3-5kg',
        Baleares_Menores: { salidas: '9,60', recogidas: '9,60', interciudad: '10,40' }
      },
      {
        weight_from: 5,
        weight_to: 10,
        label: '5-10kg',
        Baleares_Menores: { salidas: '16,09', recogidas: '16,09', interciudad: '16,89' }
      },
      {
        weight_from: 10,
        weight_to: 15,
        label: '10-15kg',
        Baleares_Menores: { salidas: '23,88', recogidas: '23,88', interciudad: '24,68' }
      },
      {
        weight_from: 15,
        weight_to: 999,
        label: 'Kg adicional',
        Baleares_Menores: { salidas: '1,83', recogidas: '1,83', interciudad: '1,88' }
      }
    ]
  },
  {
